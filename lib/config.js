module.exports = {
  ...
  TRADOVATE_IS_DEMO:   !['false','0','no'].includes((process.env.TRADOVATE_IS_DEMO||'true').toLowerCase()),
  ...
  ALLOWED_ORIGIN:      process.env.ALLOWED_ORIGIN       || (process.env.NODE_ENV === 'production' ? false : '*'),
